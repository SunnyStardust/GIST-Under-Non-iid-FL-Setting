...
def main(args):
    ...
    if non_iid:
        path = "./imgs/gist_noniid/" + args.dataset
    else:
        path = "./imgs/gist_iid/" + args.dataset
    draw_acc_curve(record, path, f"gist_noniid_graph_{args.dataset}_neuron{args.n_hidden}_layer{args.n_layers}_worker{args.num_subnet}_dropout{args.dropout}_lr{args.lr}")
...
layers = [1, 2, 3]
hiddens = [400, 800, 1200, 1600, 2000]
